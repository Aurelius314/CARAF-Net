...
def load_best_model(subject_id, device):
    ...
    model_path = f"/home/CARAF-Net/test_results_SEED/model_subject_seed3_{subject_id}.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--way", type=str, default='CARAF-Net/seed3', help="name of current way")
